...
func EncodeGameFinishedEvent(e entity.GameFinished) string {
	pbE := game.GameFinished{
		GameId: e.GameID.Hex(),
	}
...
func EncodePlayerFinishedEvent(e entity.PlayerFinished) string {
	pbE := game.PlayerFinished{
		UserId: e.UserId.Hex(),
		GameId: e.GameId.Hex(),
	}
