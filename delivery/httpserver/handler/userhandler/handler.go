...
func New(userSrv *userservice.Service, authSrv *authservice.Service, rbacSrv *rbacservice.Service, authConfig authservice.Config, userValidator uservalidator.Validator) Handler {
	return Handler{
		userSrv:       userSrv,
		authSrv:       authSrv,
		rbacSrv:       rbacSrv,
